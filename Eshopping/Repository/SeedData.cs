...
namespace Eshopping.Repository
{
    public class SeedData
    {
        ...
        _context.Products.AddRange(
                            new ProductModel { Name="Macbook",Slug="Macbook",Description="Macbook id the best",Image="1.jpg",Category=macbook,Brand=samsung,Price=1234},
                            new ProductModel { Name="Pc",Slug="Pc",Description="Pc id the best",Image="1.jpg",Category=pc,Brand=samsung,Price=1234}
                        );
